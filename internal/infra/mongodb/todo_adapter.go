...
func (a *TodoAdapter) GetByID(ctx context.Context, id todo.ID) (todo.Todo, error) {
...
func (a *TodoAdapter) Insert(ctx context.Context, t todo.Todo) (todo.ID, error) {
	...
	return todo.ID(result.InsertedID.(primitive.ObjectID).Hex()), nil
}
...
func (a *TodoAdapter) Delete(ctx context.Context, id todo.ID) error {
